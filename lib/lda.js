...
//
var process = function(sentences, numberOfTopics, numberOfTermsPerTopic, custom_stopwords, languages,  alphaValue, betaValue, randomSeed) {
    ...
    if (sentences && sentences.length > 0) {
      ...
      languages.forEach(function(value) {
          ...
          if(custom_stopwords !== null || custom_stopwords !==undefined){
